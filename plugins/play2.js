...
async (conn, mek, m, { from, quoted, body, args, q, reply }) => {
    try {
        // Checking if query is provided (Equivalent to Telegram's query check)
        ...
        // Fetching data from the API in your snippet
        ...
        // 1. Send Thumbnail with Caption (Equivalent to replyWithPhoto)
        if (thumbnail) {
        ...
        // 2. Send Direct Audio File (Equivalent to replyWithAudio)
